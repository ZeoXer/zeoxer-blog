  ...
  workExperience: [
    {
      ...
      endYear: "2024",
      descriptions: [
        "在公司實習期間內應用了諸多技術於實務方面，包括使用 Python 撰寫網路爬蟲進行資料蒐集、以 Google Apps Script 進行試算表和外部資料的整合、運用 Golang 維護後端 API 完成資料串接需求，以及透過 Next.js 框架配合 UI 設計師架設對 B 端的後臺管理系統。",
      ],
